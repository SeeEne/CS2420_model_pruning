...
def main():
    ...
    policy_loss_path = os.path.join(OUT_DIR, "encoder_block_policy_losses.json")
    ...
    if os.path.exists(encoder_path):
        ...
        encoder, summarizer, token_proj, policy_loss_history = train_policy(teacher, train_loader)

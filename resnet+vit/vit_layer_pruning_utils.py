...
"""
Utilities for layer-wise (attention / MLP) pruning of ViT on image classification tasks.

Design goals:
- Adapt HuggingFace BERT layer-wise pruning approach to timm ViT
...
def knapsack_select_mask(
    ...
    Args:
        ...
        min_mlp_layers: Minimum MLP layers to keep (default: 1).
                        ...
                        Set to 0 to disable this constraint.
        num_blocks:     Number of transformer blocks (default: 12 for ViT-Small)
    ...
    # Layout: [attn0, mlp0, attn1, mlp1, ..., attn11, mlp11]

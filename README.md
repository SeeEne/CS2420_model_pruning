...
**AZNAS_LOSS_TEST.ipynb** is a simplified version of the original code designed for Google Colab free-tier T4 GPU. This notebook runs experiments on TinyImageNet and CIFAR-100 with reduced computational requirements, making it accessible without dedicated GPU hardware.
...
**WARNING:** Installing PyTorch from `requirements.txt` does **not** install the GPU version.
